...
export default function SpaService() {
  return (
    ...
    <h1>Shoes care service at TNShoesStore</h1>
    <p>- After a period of nurturing and training a team of skilled professionals, today TNShoeStore begins launching a new service that is guaranteed to be very useful for you.
    <br/>
    ...
    <br/>
    <h1>Price for spa</h1>
    <p>- TNShoesSpa currently provides the following services:</p>
    ...
    + SLIPPERS: 60,000 VND
    <br/>
    <p>- Committed to dedication in each product, extremely fast shoe processing speed, all cleaning solutions are imported from the USA and are top-notch today.</p>
    <br/>
